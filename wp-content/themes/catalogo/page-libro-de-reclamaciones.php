...
<?php
$num_reclamo = $wpdb->get_var( "SELECT count(meta_value) FROM `wp_postmeta` WHERE meta_key = '_seq_num' ORDER BY meta_value DESC LIMIT 1");
?>
...
<div class="reclamaciones">
	...
	<img class="reclamaciones-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/libro-de-reclamaciones.png">        
        <div class="encabezado">
            <div class="reclamacion">Hoja de Reclamación Nº <?php echo str_pad($num_reclam, 6, "0", STR_PAD_LEFT); ?></div>
            <div><span class="fechatxt">Fecha de reclamo o queja:</span><span class="fecha" id="hoy"></span></div> 
			
        </div>
		<?php echo $num_reclamo;?>
